...
const Draw = styled.svg`
  ...
  .draw {
    &-1 {
      ...
      animation: ${dash2Key} 1s 0s forwards cubic-bezier(0.7, 0, 0.3, 1);
    }
    &-2 {
      animation: ${dash1Key} 1s 0s forwards cubic-bezier(0.7, 0, 0.3, 1);
    }
  }
`;
...
function Home() {
  return (
    <HomeFrame>
      <BubbleBg className="animateBubbleKey">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
      ...
      <Visual variants={visualVariants} initial="hidden" animate="visible">
        ...
        <Txt variants={txtVariants} initial="hidden" animate="visible">
          안녕하세요. <br />
          <span className="point">UI/UX Developer 최진슬 포트폴리오</span> <br />
          방문을 환영합니다.
        </Txt>
      </Visual>
    </HomeFrame>
