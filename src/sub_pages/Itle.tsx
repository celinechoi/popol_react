        ...
        <Page>
          <div className="section">
            ...
            <Content>
              ...
              <Boxes>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#ebd7fb' }}>
                    100
                  </div>
                  <span style={{ color: '#ebd7fb' }}>$primary--100</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#d6b0f7' }}>
                    200
                  </div>
                  <span style={{ color: '#d6b0f7' }}>$primary--200</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#b584e7' }}>
                    300
                  </div>
                  <span style={{ color: '#b584e7' }}>$primary--300</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#9361d0' }}>
                    400
                  </div>
                  <span style={{ color: '#9361d0' }}>$primary--400</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#6733b2' }}>
                    primary color
                  </div>
                  <span style={{ color: '#6733b2' }}>$primary--color</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#4F2599' }}>
                    600
                  </div>
                  <span style={{ color: '#4F2599' }}>$primary--600</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#3b1980' }}>
                    700
                  </div>
                  <span style={{ color: '#3b1980' }}>$primary--700</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#291067' }}>
                    800
                  </div>
                  <span style={{ color: '#291067' }}>$primary--800</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#1c0955' }}>
                    900
                  </div>
            ...
            <Content>
              ...
              <Boxes>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#fff7cf' }}>
                    100
                  </div>
                  <span style={{ color: '#fff7cf' }}>$secondary--100</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#ffeda0' }}>
                    200
                  </div>
                  <span style={{ color: '#ffeda0' }}>$secondary--200</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#ffe170' }}>
                    300
                  </div>
                  <span style={{ color: '#ffe170' }}>$secondary--300</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#ffd54d' }}>
                    400
                  </div>
                  <span style={{ color: '#ffd54d' }}>$secondary--400</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#ffc112' }}>
                    secondary color
                  </div>
                  <span style={{ color: '#ffc112' }}>$secondary--color</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#db9f0d' }}>
                    600
                  </div>
                  <span style={{ color: '#db9f0d' }}>$secondary--600</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#b78009' }}>
                    700
                  </div>
                  <span style={{ color: '#b78009' }}>$secondary--700</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#936305' }}>
                    800
                  </div>
                  <span style={{ color: '#936305' }}>$secondary--800</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#7a4e03' }}>
                    900
                  </div>
          ...
          <div className="section main">
            <Title>
              ...
              <Text className="main-txt">
                ...
                사용자들이 가장 먼저 접하는 첫화면에서 자주 사용하는 서비스를 배치하였으며 이해를 돕기 위해 아이콘을 함께 사용하였습니다. <br className="ta-hide" />
                또한 브랜드 컬러에서 도출된 서브 컬러들을 이용하여 화사하고 친근한 느낌을 주고자 하였습니다. <br className="ta-hide" />
            ...
            <ScrollWindow ref={ScrollWindowInnerRef}>
              <FontAwesomeIcon
                ...
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/itle/index.html');
                }}
              />
              <Info style={{}}>
              ...
              <Device>
                ...
                <LearnerSmartDiv>
                  <FontAwesomeIcon
                    ...
                    title="퍼블 작업물 바로가기"
                    onClick={() => {
                      window.open('https://celinechoi.github.io/Publish-vsquare/itle/myclass_degree_status.html');
                    }}
                  />
                  <LearnerSmartImg src={chartImg} />
                </LearnerSmartDiv>
              </Device>
              <Device className="ta">
                <p>Tablet</p>
                <LearnerSmartDiv>
                  <LearnerSmartImg src={chartImgTa} />
                </LearnerSmartDiv>
              </Device>
              <Device className="mo">
                <p>Mobile</p>
          ...
          <div className="section sub-bg">
            ...
            <ImgBox className="sub-map">
              <FontAwesomeIcon
                ...
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/itle/info_hello.html');
                }}
              />
              <FontAwesomeIcon
                icon={faArrowUpRightFromSquare}
                ...
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/itle/info_mission.html');
                }}
              />
              <FontAwesomeIcon
                icon={faArrowUpRightFromSquare}
                ...
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/itle/error.html');
                }}
              />
              <FontAwesomeIcon
                icon={faArrowUpRightFromSquare}
                ...
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/itle/member_login.html');
                }}
              />
              <FontAwesomeIcon
                icon={faArrowUpRightFromSquare}
                ...
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/itle/enrollment.html');
                }}
              />
              <FontAwesomeIcon
                icon={faArrowUpRightFromSquare}
                ...
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/itle/info_organization.html');
                }}
              />
              <FontAwesomeIcon
                icon={faArrowUpRightFromSquare}
                className="item7 icon-shortcuts"
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/itle/headquarters_campus.html');
                }}
              />
          ...
          <div className="section sub-campus">
            <Title>
              <TitleH1 style={{ fontSize: size2 }} className="right">
                # 캠퍼스 소개
              </TitleH1>
              <Text className="sub-campus__txt">
                시민라이프칼리지 인천시민대학 속 6개의 다양한 캠퍼스들을 소개합니다.
                <br className="mo-hide" />
                본부캠퍼스를 중심으로 인천시에 소재한 대학교이 포함되어 있는 캠퍼스들의 정보와 교육과정, 혜택 등을 이미지와 아이콘을 활용하여 만나 볼 수 있게 디자인 하였습니다.
              </Text>
            </Title>
            <Spacing>
              <ImgBox className="sub-campus-map">
                <FontAwesomeIcon
                  icon={faArrowUpRightFromSquare}
                  className="step1 icon-shortcuts"
                  title="퍼블 작업물 바로가기"
                  onClick={() => {
                    window.open('https://celinechoi.github.io/Publish-vsquare/itle/headquarters_campus.html');
                  }}
                ...
                <FontAwesomeIcon
                  icon={faArrowUpRightFromSquare}
                  className="step2 icon-shortcuts"
                  title="퍼블 작업물 바로가기"
                  onClick={() => {
                    window.open('https://celinechoi.github.io/Publish-vsquare/itle/sub_campus.html');
                  }}
                />
                <FontAwesomeIcon
                  icon={faArrowUpRightFromSquare}
                  className="step3 icon-shortcuts step3"
                  title="퍼블 작업물 바로가기"
                  onClick={() => {
                    window.open('https://celinechoi.github.io/Publish-vsquare/itle/sub_campus2.html');
                  }}
                />
