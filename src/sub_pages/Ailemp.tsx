      ...
      <PageFrame>
        <Page>
          <div className="section color">
            <Title>
              <TitleH1 style={{ fontSize: size, color: '#00BD99' }} className="color-titleh1">
                Color
              </TitleH1>
              <Text style={{ color: '#C9FBDF', backgroundColor: 'transparent' }} className="color-txt">
                직접 제작한 VSQUARE의 System Kit 아래 var_function.scss 안 $primary, $secondary 변수에 <br className="tm-hide" />
                해당 프로젝트 단계별 Primary와 Secondary Color를 각 변수에 담아 체계적인 퍼블리싱 작업을 하였습니다. <br />
                <span>
                  <FontAwesomeIcon icon={faStarOfLife} /> 전남교육청의 Primary, Secondary Color 예시입니다.
                </span>
              </Text>
            </Title>
            <Content>
              ...
              <Boxes>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#C9FBDF' }}>
                    100
                  </div>
                  <span style={{ color: '#C9FBDF' }}>$primary--100</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#95F8C9' }}>
                    200
                  </div>
                  <span style={{ color: '#95F8C9' }}>$primary--200</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#5EEBB5' }}>
                    300
                  </div>
                  <span style={{ color: '#5EEBB5' }}>$primary--300</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#35D7A9' }}>
                    400
                  </div>
                  <span style={{ color: '#35D7A9' }}>$primary--400</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#00BD99' }}>
                    primary color
                  </div>
                  <span style={{ color: '#00BD99' }}>$primary--color</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#00A292' }}>
                    600
                  </div>
                  <span style={{ color: '#00A292' }}>$primary--600</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#008887' }}>
                    700
                  </div>
                  <span style={{ color: '#008887' }}>$primary--700</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#00636D' }}>
                    800
                  </div>
                  <span style={{ color: '#00636D' }}>$primary--800</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#00495A' }}>
                    900
                  </div>
            ...
            <Content>
              ...
              <Boxes>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#CBFEF7' }}>
                    100
                  </div>
                  <span style={{ color: '#CBFEF7' }}>$secondary--100</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#97FDF8' }}>
                    200
                  </div>
                  <span style={{ color: '#97FDF8' }}>$secondary--200</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#63F5F9' }}>
                    300
                  </div>
                  <span style={{ color: '#63F5F9' }}>$secondary--300</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#3DE1F4' }}>
                    400
                  </div>
                  <span style={{ color: '#3DE1F4' }}>$secondary--400</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#00C3ED' }}>
                    secondary color
                  </div>
                  <span style={{ color: '#00C3ED' }}>$secondary--color</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#0098CB' }}>
                    600
                  </div>
                  <span style={{ color: '#0098CB' }}>$secondary--600</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#0072AA' }}>
                    700
                  </div>
                  <span style={{ color: '#0072AA' }}>$secondary--700</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#005189' }}>
                    800
                  </div>
                  <span style={{ color: '#005189' }}>$secondary--800</span>
                </Box>
                <Box>
                  <div className="color-box" style={{ backgroundColor: '#003B71' }}>
                    900
                  </div>
          ...
          <div className="section main">
            <Title className="main-title">
              <TitleH1 style={{ fontSize: size, opacity }} className="right">
                # Main
              </TitleH1>
            ...
            <ScrollWindow ref={ScrollWindowInnerRef}>
              <FontAwesomeIcon
                ...
                title="퍼블 작업물 바로가기"
                onClick={() => {
                  window.open('https://celinechoi.github.io/Publish-vsquare/ailemp/index.html');
                }}
              />
              <Info style={{ opacity }}>
              ...
              <ScrollerMain ref={ScrollerMainRef}>
                <ScrollerImg
                  ...
                  transition={{ type: 'tween', ease: [1, 0.5, 2, 0.5], delay: 1.5, repeat: Infinity, duration: 15, delayChildren: 0.5 }}
                  exit={{ y: 0 }}
                />
              </ScrollerMain>
            </ScrollWindow>
              ...
              <div className="spacing-explain">
                <div className="area">
                  <div className="clip-frame">
                    <div className="clip-inner part1"></div>
                  </div>
                </div>
                <p className="txt-normal">
                  스크롤 하여 해당 영역에 도달할 경우 누적, 일일 학습 데이터 분석, AI-LEMP와 함께한 시간의 숫자가 카운트 되는 효과를 <span className="point">Javascript의 객체로 저장하여 jQuery의 animate로 구현</span>하였습니다.
                </p>
              </div>
            </Spacing>
            <Spacing>
              <div className="spacing-explain reverse">
                <p style={{ alignSelf: 'flex-start', paddingTop: '110px' }} className="txt-normal">
                  <span className="point">GSAP 자바스크립트 플러그인을 사용하여</span> 해당 영역에 도달할 경우 <br className="lp-hide" /> 첫번째 Row는 왼쪽으로, 두번째 Row는 오른쪽으로 <span className="point">흐르는 효과</span>를 구현하였습니다. <br /> 마우스 호버시, 멈추며 해당 아이템이 포커스되어 위로 올라가는 효과는 <span className="point">transform 스타일을 사용</span>하여 on 클래스를 addClass 하여 구현하였습니다.
                </p>
                <div className="area">
                  <div className="clip-frame">
                    <div className="clip-inner part2"></div>
                  </div>
                  <div className="clip-frame edit">
                    <div className="clip-inner part2-2"></div>
                  </div>
                </div>
              </div>
            </Spacing>
          ...
          <div className="section dashboard">
            <Title>
              <TitleH1 style={{ fontSize: size2, opacity }} className="right">
                # Dashboard
              </TitleH1>
              <Text>
                ...
                나의 학습 리포트, 학습 달성현황, 학습자 종합 리포트에 보이는 Bad, Good, Nice, Exellent, Perfect는 별도 evaluation라는 객체에 담아 활용하였습니다. <br />
                또한 임시데이터를 객체에 담아 작업하여 개발자의 작업 속도 향상에 기여하였습니다.
              </Text>
            </Title>
            <Spacing className="learner-area">
              ...
              <Device className="ta">
                <p>Tablet</p>
                <LearnerSmartDiv>
                  <LearnerSmartImg src={learnerSmartTa} drag="y" />
                </LearnerSmartDiv>
              </Device>
              <Device className="mo">
                <p>Mobile</p>
                <LearnerSmartDiv ref={LearnerSmartDivMoRef} style={{ height: '502px' }}>
                  <Info>
                    <FontAwesomeIcon icon={faArrowsUpDown} />
                    Drag
                  </Info>
            ...
            <Spacing className="master-area">
              <MasterDashPc>
                <FontAwesomeIcon
                  ...
                  title="퍼블 작업물 바로가기"
                  onClick={() => {
                    window.open('https://celinechoi.github.io/Publish-vsquare/ailemp/master-dashboard.html');
                  }}
                />
              </MasterDashPc>
              ...
              <LearnerTa>
                <FontAwesomeIcon
                  ...
                  title="퍼블 작업물 바로가기"
                  onClick={() => {
                    window.open('https://celinechoi.github.io/Publish-vsquare/ailemp/learner-report-untact.html');
                  }}
                />
              </LearnerTa>
            </Spacing>
              ...
              <SubPagesDiv>
                <SubFlex>
                  <SubItem className="item1">
                    <FontAwesomeIcon
                      ...
                      title="퍼블 작업물 바로가기"
                      onClick={() => {
                        window.open('https://celinechoi.github.io/Publish-vsquare/ailemp/learner-application.html');
                      }}
                    />
                    <div></div>
                  </SubItem>
                  <SubItem className="item2">
                    <FontAwesomeIcon
                      ...
                      title="퍼블 작업물 바로가기"
                      onClick={() => {
                        window.open('https://celinechoi.github.io/Publish-vsquare/ailemp/join2.html');
                      }}
                    />
                    <div></div>
                  </SubItem>
                ...
                <SubFlex>
                  <SubItem className="item3">
                    <FontAwesomeIcon
                      ...
                      title="퍼블 작업물 바로가기"
                      onClick={() => {
                        window.open('https://celinechoi.github.io/Publish-vsquare/ailemp/profile-select.html');
                      }}
                    />
                    <div></div>
                  </SubItem>
                  <SubItem className="item4">
                    <FontAwesomeIcon
                      ...
                      title="퍼블 작업물 바로가기"
                      onClick={() => {
                        window.open('https://celinechoi.github.io/Publish-vsquare/ailemp/learner-result.html');
                      }}
                    />
                    <div></div>
                  </SubItem>
                ...
                <SubItem className="item5">
                  <FontAwesomeIcon
                    ...
                    title="퍼블 작업물 바로가기"
                    onClick={() => {
                      window.open('https://celinechoi.github.io/Publish-vsquare/ailemp/contact.html');
                    }}
                  />
                  <div></div>
                </SubItem>
