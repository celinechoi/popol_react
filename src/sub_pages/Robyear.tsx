...
import fullMp4 from 'img/sub_pages/gravity/event/rob_year/full.mp4';
import mainKo from 'img/sub_pages/gravity/event/rob_year/page.webp';
import mainMo from 'img/sub_pages/gravity/event/rob_year/page_mo.png';
